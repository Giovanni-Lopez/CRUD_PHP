...
<body>
    ...
    if(isset($_POST['insertar'])){
        ...
        <!--********Estilos del formulario de buscar********-->               
        <style type="text/css">
        .busc{            
            padding: 10px;
            border-radius: 5px; 
        ...
        <div class="container">
            <form action="" method="post">
                <div class="form-groud">                
                    <input type="text" class= "busc form-group" name="busqueda" placeholder="Realizar Buscar" required> <button type="submit" class= "consul btn btn-primary">Consultar</button>  <a href="index.php"> <button type="button" class="consul btn btn-info">Ver Registros</button></a>
                </div>                                                                           
            </form>
        </div>   
         ...
         <?php
            if(isset($_POST['busqueda'])){
                $valor_de_busqueda = $_POST['busqueda'];
        ?>
         ...
         <div class="table-responsive">
            ...
            <tbody>
                <?php                   
                    $sql = "SELECT * FROM tbl_personal WHERE id = $valor_de_busqueda ORDER BY id ASC";
